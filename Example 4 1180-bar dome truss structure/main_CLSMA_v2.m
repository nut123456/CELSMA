...
for i = 1:Times
    ...
    Convergence_curve_CLSMA_all(i,:) = Convergence_curve(i,:); % Save for each run
    display(['The optimal fitness of LESMA (Run ', num2str(i), ') is: ', num2str(Destination_fitness(i)), ' (Chaos Index: ', num2str(chaos_index), ')']);
...
display(['The best location of CELSMA is: ', num2str(bestPositions(index,:))]);
