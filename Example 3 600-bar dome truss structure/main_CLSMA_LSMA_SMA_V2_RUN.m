...
Times = 1; % Number of independent times you want to run the SMA, LSMA, CLSMA
...
legend('Best, SMA', 'Mean, SMA', 'Best, LSMA', 'Mean, LSMA', 'Best, CELSMA', 'Mean, CELSMA');
title(['Example 3']);
box on; axis tight; grid on;
current_ylim = ylim;
ylim([current_ylim(1)*0.85, current_ylim(2)]);
% Save the figure
saveas(gcf, 'convergence_curves_Example3.png');
